        ...
        >
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-10 w-full rounded-xl border border-white/[0.06] bg-white/[0.03] pl-10 pr-4 text-sm text-white placeholder-gray-500 outline-none transition-colors focus:border-indigo-500/30 focus:bg-white/[0.05]"
            />
            {search && (
              <button
                type="button"
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex overflow-hidden rounded-xl border border-white/[0.06]" role="group" aria-label="View mode toggle">
              <button
                type="button"
              ...
              <div className="glass rounded-xl p-4">
                ...
                {(search || category !== "all" || status !== "all") && (
                  <button
                    ...
                    className="mt-3 flex items-center gap-1.5 text-xs text-gray-400 transition-colors hover:text-white"
                  >
                    <X size={12} />
                    Clear all filters
                  </button>
