      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-12 pt-8 sm:px-6 lg:px-8 lg:pt-16">
          ...
          <motion.button
            ...
            onClick={() => navigate("/projects")}
            aria-label="Back to projects list"
            className="mb-6 flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm text-gray-400 transition-colors hover:text-white focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
          >
            <ArrowLeft size={14} aria-hidden="true" />
            Back to Projects
          </motion.button>
